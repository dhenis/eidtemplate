...
class _DashboardPageState extends State<DashboardPage> {
  // Color primaryColor = Color.fromRGBO(254, 234, 254, 1);
  Color primaryColor = Color.fromRGBO(110, 204, 255, 1);

  @override
  Widget build(BuildContext context) {
    var data = [
      ClickPerMonth('2018', 30, Colors.purple),
      ClickPerMonth('2019', 42, Colors.blue),
      ClickPerMonth('2020', 54, Colors.purple),
